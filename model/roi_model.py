...
class BoxMultiHeadedAttention(nn.Module):
    ...
    def BoxRelationalEmbedding(
        self, f_g, dim_g=64, wave_len=1000, trignometric_embedding=True
    ):
        """
    ...
    def forward(self, input_query, input_key, input_value, input_box, mask=None):
        ...
        flatten_relative_geometry_embeddings = flatten_relative_geometry_embeddings.to(
            dtype=input_query.dtype
        )  # FP16
